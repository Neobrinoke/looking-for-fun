...
<?php ob_start(); ?>
	...
	<div class="ui large top fixed hidden menu">
		<div class="ui container">
			...
			<a class="item" href="<?= route('gameGroup.index') ?>">Groupes</a>
			<div class="right menu">
				<?php if (auth()->isLogged()): ?>
					...
					<div class="item">
						<a class="ui primary button" href="<?= route('security.logout') ?>">Deconnexion</a>
					</div>
				<?php else: ?>
					<div class="item">
						<a class="ui button" href="<?= route('security.login') ?>">Se connecter</a>
					</div>
					<div class="item">
						<a class="ui primary button" href="<?= route('security.register') ?>">S'inscrire</a>
					</div>
				<?php endif; ?>
			</div>
		</div>
	...
	<div class="pusher">
		<header class="ui inverted vertical masthead center aligned segment" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8)),url('/img/Wallpaper-Gaming-049.jpg') center center no-repeat;">
				...
				<div class="ui large secondary inverted pointing menu">
					...
					<div class="right item">
						<?php if (auth()->isLogged()): ?>
							...
							<a class="ui inverted button" href="<?= route('security.logout') ?>">Deconnexion</a>
						<?php else: ?>
							<a class="ui inverted button" href="<?= route('security.login') ?>">Se connecter</a>
							<a class="ui inverted button" href="<?= route('security.register') ?>">S'inscrire</a>
						<?php endif; ?>
					</div>
				</div>
			</div>
			<div class="ui text container">
				...
				<a href="<?= route('gameGroup.create') ?>" class="ui huge primary button">Crée un groupe !<i class="right arrow icon"></i></a>
			</div>
		</header>
